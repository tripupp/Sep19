...
;( function( $, window, document, undefined ) {
    ...
    $.extend( Plugin.prototype, {
        ...
        widget_html: function() {
            ...
            '        '+
            '            '+
            '                <a href="#twidget-tab1">'+_this.settings.localization.avia_tab_caption+'</a></li>'+
            '                <a href="#twidget-tab2">'+_this.settings.localization.hotel_tab_caption+'</a></li>'+
            '            </ul>'+
            '        </nav>'+
            '        <!-- tabs -->'+
            ...
            '                <form action="' + _this.settings.localization.avia_submit_domain + '" method="get" autocomplete="off" ' + (_this.settings.open_in_new_tab ? 'target=""' : '') + '>'+
            ...
            '                <div class="" ' + (_this.settings.open_in_new_tab ? 'target=""' : '') + '>'+
            ...
            '                </div>'+
            '                <form action="https://search.hotellook.com/" method="get" autocomplete="off" ' + (_this.settings.open_in_new_tab ? 'target=""' : '') + '>'+
            '                    <ul class="twidget-form-list clearfix">'+
            '                        <!-- hotel city input -->'+
